...
def parse_args():
    ...
    parser.add_argument('--data_path', default='B:/cs685/dataset/DBLP/dblp.csv', type=str, help='Dataset Path')
    parser.add_argument('--preprocessed', default=False, type=bool, help='Dataset Preprocessing [True/False]')
